...
**impulse** could always use more documentation, whether as
part of the official **impulse** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `impulse` for local
development.

1. Fork the `impulse` repo on GitHub.
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd impulse
    (dvlpt) impulse$ flake8
    (dvlpt) impulse$ pytest
...
Before you submit a pull request, check that it meets these guidelines:
  ...
  3. The pull request should work for Python 36.
     Check `Travis <https://travis-ci.org/moi/impulse/pull_requests>`_
...
.. _issues: https://github.com/moi/impulse/issues
