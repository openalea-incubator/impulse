...
# -*- coding: utf-8 -*-
#
# Package impulse documentation build configuration file, created by
...
# [howto/manual]).
latex_documents = [
    (u"index", u"impulse.tex",
     u"impulse Documentation",
     u"moi", u"manual"),
]
